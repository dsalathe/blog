...
*(We'll return to explore all eight saga types in the next section of this article, where each pattern receives detailed treatment with concrete examples from Commit Esports.)*